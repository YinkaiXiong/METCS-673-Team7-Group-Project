...
// import { Server, ServerData, OperationSystem } from '../models/model';
...
// const mockedOperationSystem = OperationSystem as jest.Mocked<typeof OperationSystem>;
// const mockReq = {
...
//         const mockServerData = [{ /* Mock server data */ }];
//         mockedServerData.find.mockResolvedValue(mockServerData);
//         const result = await serverService.saveServerData({ hostname: 'TestServer' });
//         expect(mockedServerData.find).toHaveBeenCalledWith({ hostname: 'TestServer' });
//         expect(result).toEqual({ found: true, result: mockServerData });
//     });
